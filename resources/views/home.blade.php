...
@section('content')
    ...
    <img src="imgs/tts_land.png" alt="Bon Air UMC Tinsel and Tennis Shoes 5k" class="img-responsive ">    
            ...
            <div class="row">
                <div class="col-md-9">
                    <p>The 1st Annual Tinsel and Tennis Shoes 5K race has a little something for everyone. The run and walk will be held on Saturday, January 9th, 2016 at 9 a.m. and will feature a competitive 5K race or a 5K fun walk through the neighborhood, and a festive costume contest. Come on out and spread holiday cheer into the New Year with us!</p>
        ...
        <div class="feature">
            ...
            <div class="col-md-4 col-xs-12">
                <a href="http://bonairumc.org" class="thumbnail">
